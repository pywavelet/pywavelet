...
`PyWavelet` is a Python package for transforming 1D data into the wavelet
domain.
...
<img src="_static/demo.gif" alt="Demo GIF" style="max-width: 80%; height: auto;">

## Acknowledging PyWavelet

If you use `PyWavelet` in your research, please acknowledge it by citing the
following works:
