...
The simplest way to install pywavelet is using Pip.

.. code-block:: console

    $ pip install pywavelet

This will install ``pywavelet`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/avivajpeyi/pywavelet/issues>`_.
