...
def __symlog_bins(data: np.ndarray, lin_thresh=None, log_base=10, num_lin=5, num_log=10):
...
def plot_wavelet_comparison(cur: Wavelet, cached: Wavelet, err: Wavelet, label: str, outdir: str):
    ...
    axes[2].text(0.05, 0.85, textstr, transform=axes[2].transAxes, fontsize=14,
...
def plot_timedomain_comparisons(ht: TimeSeries, h_reconstructed: TimeSeries, wavelet: Wavelet, fname: str):
