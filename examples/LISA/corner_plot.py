...
corner_kwrgs = dict(plot_datapoints=False,smooth1d=True,
                    labels=params, 
...
corner(samples_FD,bins = 30, fig=figure, weights = weights, color = 'red', **corner_kwrgs)
...
plt.legend(handles=[blue_line,red_line], fontsize = 15, frameon = True, bbox_to_anchor=(0.5, N_param), loc="upper right", title = r"Domain Comparison", title_fontproperties = FontProperties(size = 15, weight = 'bold'))
